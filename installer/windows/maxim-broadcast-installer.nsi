; Maxim Broadcast v1.4.0 - NSIS Installer Script
; Copyright (c) 2026 EstacionKusMedia
; License: GNU GPL v2.0

!include "MUI2.nsh"

Name "Maxim Broadcast v1.4.0"
OutFile "maxim-broadcast-v1.4.0-windows-x64-setup.exe"
...
!define MUI_WELCOMEPAGE_TITLE "Bienvenido a Maxim Broadcast v1.4.0"
...
Section "Maxim Broadcast Core" SecCore
  ...
  WriteRegStr HKLM "Software\MaximBroadcast" "Version" "1.4.0"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\MaximBroadcast" "DisplayName" "Maxim Broadcast v1.4.0"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\MaximBroadcast" "DisplayVersion" "1.4.0"
